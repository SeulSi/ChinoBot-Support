...
<div>
	<div style="padding-top: 8px; width: 70%;">
		...
		<select id="info" class="round">
			...
			<option value="14">Server Voice Channel List</option>
			<option value="15">Server Role List</option>
			<option value="16">Server Member List</option>
			<option value="17">Server Emoji List</option>
		</select>
	</div>
</div><br>
<div>
...
action: function(cache) {
	...
	switch(info) {
		...
		case 13:
			...
			break;
		case 14:
			result = targetServer.voiceChannel;
			break;
		case 15:
